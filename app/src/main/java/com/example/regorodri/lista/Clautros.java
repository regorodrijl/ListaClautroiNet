package com.example.regorodri.lista;
...
public class Clautros extends Activity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == 1) {
            if (resultCode == RESULT_OK) {
                if (data.hasExtra("codProfe")) {
                    listView.getChildAt(data.getExtras().getInt("codProfe")).setBackgroundColor(Color.RED);
                }
            } else
    ...
    */
    public class ReadJSONTask extends AsyncTask<String, Void, ArrayAdapter<String>> {
        private ProgressDialog dialog = new ProgressDialog(Clautros.this);
        ...
        protected ArrayAdapter<String> doInBackground(String... urls) {
            ...
            ArrayAdapter<String> adaptador = new ArrayAdapter<String>(Clautros.this,
